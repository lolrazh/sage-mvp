...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-[#F9F1E8]">
      ...
      >
        <div className="w-12 h-12 rounded-full bg-[#F9F1E8] border border-[#333333]/10 flex items-center justify-center mb-4">
          <svg viewBox="0 0 24 24" className="w-6 h-6 text-[#333333]" fill="none" stroke="currentColor" strokeWidth="1.5">
